...
XML_UTIL["xml.py<br>svg_tag(), extract_root_languages()"]
...
* **`xml.py`**: Provides SVG-specific helpers like `svg_tag` (Clark notation), `extract_root_languages` (extracting `systemLanguage` values), and `sort_switch_children` for deterministic XML ordering [docs/refactor/utils.md L99-L170](https://github.com/MrIbrahem/CopySVGTranslation/blob/d984a401/docs/refactor/utils.md?plain=1#L99-L170)
