...
2. **Language Snapshot**: The system records existing languages using `tree_languages()` before any changes are made [CopySVGTranslation/injection/injector.py L114-L115](https://github.com/MrIbrahem/CopySVGTranslation/blob/d984a401/CopySVGTranslation/injection/injector.py#L114-L115)
