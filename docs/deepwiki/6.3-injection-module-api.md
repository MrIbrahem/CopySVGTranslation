...
>
> -   [CopySVGTranslation/injection/**init**.py](https://github.com/MrIbrahem/CopySVGTranslation/blob/d984a401/CopySVGTranslation/injection/__init__.py)
...
2. **Language Snapshot**: Records languages present in the SVG before injection using `extract_root_languages()` [CopySVGTranslation/injection/injector.py L114-L115](https://github.com/MrIbrahem/CopySVGTranslation/blob/d984a401/CopySVGTranslation/injection/injector.py#L114-L115)
