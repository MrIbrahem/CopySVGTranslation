        ...
        for text_el in children:
            ...
            for lang in real_langs:
                if lang in languages_present:
                    raise SvgStructureError(code="structure-error-multiple-lang-in-text", extra=[lang])
                languages_present.add(lang)

                if lang in existing_langs:
                    raise SvgStructureError(code="structure-error-multiple-text-same-lang", extra=[lang])
