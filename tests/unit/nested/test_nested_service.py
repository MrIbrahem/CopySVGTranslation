...
class TestNestedFromSVGTranslationService:
    def test_svg_translation_service_analyze_nested(self, tmp_path: Path):
...
class TestRepairRoot:
    """
    Tests for NestedStructureService.repair_root method.
    """

    def test_nested_structure_service_repair_in_place(self):
