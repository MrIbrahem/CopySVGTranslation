...
class TestSVGTranslate(TestSetup):
    ...
    def test_extract_case_insensitive(self):
        ...
        translations = extract_translations(arabic_svg_path, case_insensitive=True)
    ...
    def test_extract_nonexistent_file(self):
        ...
        translations = extract_translations(nonexistent_path)
...
<svg xmlns:svg="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/2000/svg"
    ...
    def test_inject_nonexistent_file(self):
        ...
        result = inject_translations(inject_file=nonexistent_path, mapping_files=[mapping_path])
