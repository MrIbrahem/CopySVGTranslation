...
<svg xmlns:svg="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/2000/svg"
    ...
    <switch>
        ...
        translations = extract_translations(svg_path)
    ...
    def test_extract_directory_path(self):
        ...
        result = extract_translations(self.test_dir)
...
<svg xmlns:svg="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/2000/svg">
    ...
    def test_inject_preserves_original_structure(self):
        ...
        tree = inject_translations(inject_file=_path, mapping_files=[mapping_path])
...
<svg xmlns:svg="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/2000/svg">
    ...
    def test_extract_and_inject_roundtrip(self):
        ...
        translations = extract_translations(arabic_svg_path)
        assert translations is not None
    ...
    def test_inject_invalid_json_mapping(self):
        ...
        result = inject_translations(inject_file=_path, mapping_files=[mapping_path])
        assert result is None
